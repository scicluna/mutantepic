...
export function armorTable() {
    return [
        ...
        { num: 4, result: `Leather jacket ${roll(10) <= 4 ? `and a wicker shield` : ''} ${roll(10) <= 3 ? `and a leather helmet` : ''}` },
        { num: 5, result: `Leather armor ${roll(10) <= 5 ? `and a buckler (shield)` : ''} ${roll(10) <= 5 ? `and an iron cap helmet` : ''}` },
        ...
        { num: 9, result: `Leather armor ${roll(10) <= 4 ? `and a breast plate` : ''} ${roll(10) <= 7 ? `and an iron helmet` : ''}` },
        { num: 10, result: `Junk armor ${roll(10) <= 4 ? `and a junk Shield` : ''} ${roll(10) <= 7 ? `and a junk helmet` : ''}` },
        ...
        { num: 14, result: `Part plate armor ${roll(10) <= 4 ? `and a standard shield` : ''} ${roll(10) <= 5 ? `and a full iron helmet` : ''}` },
